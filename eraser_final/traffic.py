...
class Traffic_serv_clients:
    ...
    def __str__(self):
        return ("Traffic type: %s, Servers: %s, Clients of the servers: %s, Instances: %d" %
                (self.tr_type, str(self.servers_nodes), str(self.clients_nodes_per_server), self.instances_per_client))
